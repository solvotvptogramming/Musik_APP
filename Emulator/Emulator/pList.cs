...
namespace Emulator
{
    ...
    public partial class pList
    {
        ...
        public pList()
        {
            this.ClientFieldsValues = new HashSet<ClientFieldsValues>();
            this.Guest = new HashSet<Guest>();
            this.tPersonalStuff = new HashSet<tPersonalStuff>();
            this.tPStuffPhoto = new HashSet<tPStuffPhoto>();
        ...
        public virtual ICollection<ClientFieldsValues> ClientFieldsValues { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Guest> Guest { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tPersonalStuff> tPersonalStuff { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tPStuffPhoto> tPStuffPhoto { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
